...
public class MainEntry extends PreferenceActivity implements OnDismissListener {
    ...
    private static MainEntry mInstance;
    ...
    private Handler mUiHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case SystemUpdateService.MSG_UNKNOWERROR:
                ...
                processOtaBehavior();
                Toast.makeText(MainEntry.this, R.string.unknown_error_content, Toast.LENGTH_LONG).show();
    ...
    /**
     * Tank_Problem
     * 如果 mService 服务没启动mUpdateInfoList必然为空
     * @return
     */
    ...
    private void refreshUI() {
        ...
        if (isOtaPackageExist()) {
            if (size == 0) {
                ...
                Xlog.v(TAG, "[refreshUI] one OTA package & one SD packge, NO need devider");

                addPreference(null, mParentPreference);
                addPreference(mUpdateInfoList.get(0), mParentPreference);
    ...
    private boolean isOtaPackageExist() {
        return mDownloadInfo.getDLSessionStatus() == DownloadInfo.STATE_NEWVERSION_READY;
    }
