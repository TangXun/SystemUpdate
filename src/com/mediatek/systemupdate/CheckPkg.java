...
class CheckPkg {
    ...
    private static final int PARTITION_SEC_NUM_DEV = 5;
     ...
     * PartitionInfo是用来记录一个分区信息的名称和抵消。
     * 
     * @author mtk80357
     */
     ...
     * LoadVersionInfo记录版本相关信息的一个当前加载的或升级包。
     * 
     * @author mtk80357
     */
    ...
    private boolean getPartitionInfoDev(List<PartitionInfo> partitionDev) {
        ...
        try {
            ...
            while ((line = bfReader.readLine()) != null) {
                ...
                if (partitionInfoArray.length != PARTITION_SEC_NUM_DEV) {
                    continue;
                }
